                ...
                <div className="max-w-[320px] mx-auto py-16">
                    ...
                    >
                        ...
                        <input className='p-3 my-2 bg-gray-600 rounded' type="password" placeholder='Password' 
                            ...
                            />
                        <button type='submit' className="bg-red-600 text-white font-bold p-3 my-6 rounded">Sign up</button>
                        ...
                        <p className='mt-20 text-white '>
                            <span className='text-xm text-gray-400 mr-2'>Already have an account?</span >
